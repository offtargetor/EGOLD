...
# 加载数据
data = pd.read_csv(input_file, sep="\t", encoding_errors="ignore")

# 选择特征（与训练时保持一致）
features = data[['dnase', 'elk4', 'h3k27ac', 'h3k36me3', 'h3k4me1', 'h3k9me3', 'rnap', 'tcf7l2', 'trim28', 'znf274', 'atac', 'fpkm', 'meth', 'p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9',
